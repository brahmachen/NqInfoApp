...
public class NqltCommentAdapter extends BaseAdapter {

	private Context context;
	private ArrayList<AisLtComment> entitys = new ArrayList<AisLtComment>();
	...
	public NqltCommentAdapter(Context context, ListViewForWebView mListView) {
		super();
	...
	public void addData(ArrayList<AisLtComment> entitys) {
		if (entitys != null) {
	...
	public void addDataFromHead(AisLtComment entity) {
		if (entity != null) {
	...
	public ArrayList<AisLtComment> getData() {
		return entitys;
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final AisLtComment item = (AisLtComment) getItem(position);
		...
		case Constants.SOCIALIZATION_REPLAY:
			...
			replyHolder.tv_reply_comment_date.setText(item.getCommentedUser()
					.getDate());
	...
	public void Zan(String id, String userId , final long flag, final int pinglunOrReplyFlag) {
		...
		MyHttpAPIControl.newInstance().zanAisLtComment(baseParams,
	...
	public void CancleZan(String id, String userId ,  final long flag, final int pinglunOrReplyFlag) {
		...
		MyHttpAPIControl.newInstance().cancleZanAisLtComment(baseParams,
				new AsyncHttpResponseHandler() {
